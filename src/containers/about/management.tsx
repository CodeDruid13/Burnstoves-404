...
const ManagementSection = ({ managementdata }: { managementdata?: any }) => {
  const items = [
    {
      id: 1,
      image:
        ...
        >
          ...
          >
            <VStack align={"center"} spacing={6} w="full">
              ...
              >
                Our <Highlight strokeColor={"brand.300"}>Management</Highlight>{" "}
                Team
              </Text>
              ...
              {managementdata ? (
                managementdata?.teams?.data?.length ? (
                  <SimpleGrid
                    mb={[5, 5, 5]}
                    spacing={[5, 5, 5]}
                    columns={[1, 1, 2, 5]}
                    ...
                    // flexWrap={"wrap"}
                  >
                    {managementdata?.teams?.data?.map((item: any) => (
                      <Link
                        key={item?.id}
                        href={{
