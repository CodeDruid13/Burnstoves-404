...
const ProductsBlockSectionSingle = ({
  productsdata,
  tag,
  bg,
}: {
          ...
          {productsdata ? (
            productsdata?.products?.data?.length ? (
              <SimpleGrid
                ...
                flexWrap={"wrap"}
              >
                {productsdata?.products?.data?.map((item: any) => (
                  <Link
                    key={item?.id}
                    href={"/products/wood-stoves/kuniokoa/"}
                    passHref
                  ...
                  >
                    ...
                    >
                      <VStack align="center" spacing={5}>
                        <Flex width="250px" height="250px" align={"start"}>
                          <NextImage
                            src={
...
export default ProductsBlockSectionSingle;
