...
const ProductsStats = ({ impactsdata }: { impactsdata?: any }) => {
  const board = [
    {
      id: 1,
        ...
        >
          ...
          >
            <VStack align={"center"} spacing={6} w="full">
              {impactsdata ? (
                impactsdata?.product?.data?.attributes?.product_reports
                  ?.length ? (
                  <SimpleGrid
                    width="full"
                    columns={[2, 2, 2, 4]}
                    ...
                    alignContent={"center"}
                  >
                    {impactsdata?.product?.data?.attributes?.product_reports?.map(
                      (item: any) => (
                        <Box
                          pos="relative"
                          p={6}
