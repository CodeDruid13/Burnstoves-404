            ...
            >
              <VStack align={"center"} justify={"center"}>
                <Link
                  ...
                  p={2}
                  fontSize={"16px"}
                  fontWeight={page === "contact" ? "bold" : "normal"}
                  fontFamily={"Ubuntu"}
                  color={"white"}
                  _hover={{
                    textDecoration: "none",
              ...
              <VStack align={"center"} justify={"center"}>
                <Link
                  ...
                  p={2}
                  fontSize={"16px"}
                  fontWeight={page === "distributors" ? "bold" : "normal"}
                  fontFamily={"Ubuntu"}
                  color={"white"}
                  _hover={{
                    textDecoration: "none",
              ...
              <VStack align={"center"} justify={"center"}>
                <Link
                  ...
                  p={2}
                  fontSize={"16px"}
                  fontWeight={page === "warranty" ? "bold" : "normal"}
                  fontFamily={"Ubuntu"}
                  color={"white"}
                  _hover={{
                    textDecoration: "none",
              ...
              <VStack align={"center"} justify={"center"}>
                <Link
                  ...
                  p={2}
                  fontSize={"16px"}
                  fontWeight={page === "help" ? "bold" : "normal"}
                  fontFamily={"Ubuntu"}
                  color={"white"}
                  _hover={{
                    textDecoration: "none",
...
export default HeroBannerSupport;
