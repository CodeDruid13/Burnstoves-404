...
const HeroBannerBottomNavigationSingleProductSection = ({
  bannerdata,
  type,
}: {
  bannerdata?: any;
      ...
      >
        ...
        >
          <Center
            ...
            h="75px"
            color="white"
            textStyle={{ base: "text_xs_bold", md: "text_md_bold" }}
            px={{ base: 4, md: 0 }}
            bg={"grey"}
          >
            {type}
...
export default HeroBannerBottomNavigationSingleProductSection;
